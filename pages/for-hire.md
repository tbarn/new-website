...
I've often found a disconnect between the product engineers, the Marketing team, the Sales team, and the users. (You also have the decision makers, buyers, and other personas to consider, but let's stay focused here.) 
...
- Designed user product journeys based on product data with a Sales team so they could PQL users
